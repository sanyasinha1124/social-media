        ...
        {stories.map((story, index) => (
          ...
          >
            <img
              ...
              alt=""
              className="absolute top-3 left-3 z-10 rounded-full ring ring-gray-100 shadow w-8 h-8"
            />
            ...
            {story.media_type !== "text" && (
              <div className="ansolute inset-0 z-1 rounded-lg  bg-black overflow-hidden">
                {story.media_type == "image" ? (
                  <img
                    src={story.media_url}
                    alt=""
                    className="h-full w-full object-cover
                  hover:scale-110 transition suration-500 opacity-70 hover:opacity-80"
                  />
                ) : (
                  <video
                    src={story.media_url}
